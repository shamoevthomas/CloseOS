// Miroir de src/lib/formBlocks.ts — conservé dans api/_lib/ selon la convention Vercel
// où les fichiers api/ ne peuvent pas importer depuis src/. Garder les deux en phase.
