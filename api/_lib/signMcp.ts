...
// Imports STATIQUES uniquement : @vercel/node (esbuild) inline les deps importées statiquement.
// Les import() dynamiques ne sont PAS tracés par Vercel → packages absents au runtime (ERR_MODULE_NOT_FOUND).
...
export function buildSignMcpServer(): any {
