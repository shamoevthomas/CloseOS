...
import {
  ...
  Briefcase, BookOpen, ScrollText, Tag
} from 'lucide-react';
...
export default function CallRoom() {
  ...
  return (
    <div className="flex h-screen w-screen bg-slate-950 text-white flex-col font-sans">
      ...
      {/* --- HEADER --- */}
      <div className="h-16 shrink-0 border-b border-slate-800 bg-slate-900 px-6 flex items-center justify-between shadow-md z-50">
