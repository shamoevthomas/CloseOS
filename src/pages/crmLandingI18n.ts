...
const fr: Translations = {
  ...
  hero_badge_closers: '14 jours gratuits',
  hero_badge_closers_text: 'Avec {count}, annulable à tout moment',
  ...
  dashboard_description: 'Suivez vos KPIs en temps réel : CA, taux de closing, prospects en cours, RDV du jour.',
  kpi_ca_reel: 'CA Réel Stripe',
  kpi_ca_closer: 'CA du mois',
  kpi_taux_closing: 'Taux de Closing',
  kpi_taux_noshow: 'Taux de No-show',
  kpi_vs_last_month: 'vs mois dernier',

  // Team section repurposed → Integrations natives
  team_title: "Connectez tous vos outils",
  team_description: "Zapier, Make, N8N, API REST avec webhooks signés HMAC. Hubspot, Pipedrive, GoHighLevel, Airtable pour vos imports. Google Calendar pour la synchro. Stripe pour les paiements. Tout s'orchestre automatiquement.",
  team_member_conv: 'Actif',
  team_member_online: 'Connecté',

  // Shared Pipeline → Visual Pipeline
  pipeline_title: 'Pipeline visuel',
  pipeline_description: 'Un kanban clair avec stages personnalisables, code couleur et drag-and-drop pour un suivi impeccable.',
  ...
  revenue_kpi_commissions_sub: 'ce mois',
  revenue_kpi_churn_change: '-0.5% vs dernier',

  // Onboarding
  onboarding_label: 'Automatisations',
  onboarding_title: 'Vos outils, vos règles, zéro friction',
  onboarding_description: "Zapier, Make, N8N et une API REST signée HMAC : chaque événement de votre CRM peut déclencher une action ailleurs. Envoyez vos leads vers votre outil email, synchronisez avec Notion, Google Sheets ou Airtable en temps réel.",
  onboarding_item_reporting: 'Webhooks sortants signés HMAC',
  onboarding_item_exports: 'API REST pour tous vos outils no-code',
  onboarding_box_scripts_title: 'Zapier',
  onboarding_box_scripts_desc: '7 000+ apps connectables.',
  onboarding_box_videos_title: 'Make (Integromat)',
  onboarding_box_videos_desc: 'Scénarios visuels complexes.',
  onboarding_box_progress_title: 'N8N',
  onboarding_box_progress_desc: 'Self-hosted et open-source.',
  onboarding_box_exports_title: 'API + Webhooks',
  onboarding_box_exports_desc: 'Signature HMAC, events temps réel.',
  ...
  crm_feature_pipeline_desc: "Stages personnalisables, drag & drop, filtres par tag, source, statut. Vous voyez exactement où en est chaque deal.",
  ...
  capture_description: "Créez des pages de capture, intégrez un formulaire en embed ou lancez un popup directement sur votre site. Chaque lead est automatiquement injecté dans votre CRM avec le bon prospect enregistré.",
    ...
    features: [
      {
        ...
        items: [
          ...
          'Assignation propriétaire : manuelle, tournante ou hasard',
  ...
  role_setter: {
    ...
    description: 'Focalisé sur la qualification et le booking. Qualifiez vos prospects, assignez les prospects et gérez votre flow de prise de RDV.',
    features: [
      {
  ...
  demo_title: 'Réservez une démo personnalisée',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "Oui. En plus de notre propre CRM intégré, CloseOS CRM se connecte nativement à 6 plateformes : HubSpot (synchronisation complète bidirectionnelle), Pipedrive (synchronisation complète bidirectionnelle), GoHighLevel GHL (synchronisation complète bidirectionnelle), Airtable (synchronisation complète bidirectionnelle), Systeme.io (import de contacts via webhook), iClosed (synchronisation unidirectionnelle via webhook), CSV (importez/exportez vos prospects depuis n'importe quel outil). Un prompt IA intégré permet de reformater automatiquement n'importe quel fichier CSV pour le rendre compatible avec CloseOS. Cela dit, nous recommandons d'utiliser le CRM intégré CloseOS CRM : c'est lui qui offre les meilleures performances et la gestion la plus simple dans cet écosystème. Tout est conçu pour fonctionner ensemble, sans friction.",
    },
    {
    ...
    },
    {
      ...
      answer: "Oui. CloseOS CRM est 100% conforme au RGPD. Toutes les données sont hébergées de manière sécurisée, isolées par organisation, et aucun tiers n'y a accès. Vous restez propriétaire de vos données à tout moment.",
    },
    {
    ...
    },
    {
      ...
      answer: "Autant que vous voulez. CloseOS CRM n'impose aucune limite sur la taille de vos prospects.",
    },
    {
  ...
  sd_faq_what_a: "CloseOS CRM est la plateforme de management pour entrepreneurs et Head of Sales francophones. Elle permet de gérer une équipe de closers et setters, piloter les campagnes d'acquisition, suivre les KPIs d'équipe et automatiser l'onboarding des prospects. C'est l'alternative française à iClosed, conçue pour le pilotage d'équipe closing.",
  sd_faq_how_many_q: 'Combien de closers puis-je ajouter dans CloseOS CRM ?',
  sd_faq_how_many_a: "Autant que vous voulez. CloseOS CRM n'impose aucune limite sur la taille de votre business solo et setters.",
  sd_faq_gdpr_q: 'Les données sont-elles sécurisées et conformes au RGPD ?',
  sd_faq_gdpr_a: "Oui. CloseOS CRM est 100% conforme au RGPD. Toutes les données sont hébergées de manière sécurisée, isolées par organisation, et aucun tiers n'y a accès. Vous restez propriétaire de vos données à tout moment.",
}
...
const en: Translations = {
  ...
  capture_description: 'Create capture pages, embed a form or launch a popup directly on your site. Each lead is automatically injected into your CRM with the right propriétaire assigned.',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'Yes. In addition to our own built-in CRM, CloseOS CRM natively connects to 6 platforms: HubSpot (full bidirectional sync), Pipedrive (full bidirectional sync), GoHighLevel GHL (full bidirectional sync), Airtable (full bidirectional sync), Systeme.io (contact import via webhook), iClosed (unidirectional sync via webhook), CSV (import/export your prospects from any tool). A built-in AI prompt automatically reformats any CSV file to make it CloseOS-compatible. That said, we recommend using the built-in CloseOS CRM CRM: it offers the best performance and simplest management in this ecosystem. Everything is designed to work together, without friction.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Yes. CloseOS CRM is 100% GDPR-compliant. All data is securely hosted, isolated by organization, and no third party has access. You remain the owner of your data at all times.',
    },
    {
    ...
    },
    {
      ...
      answer: 'As many as you want. CloseOS CRM imposes no limit on your team size.',
    },
    {
  ...
  sd_faq_what_a: "CloseOS CRM is the management platform for French-speaking entrepreneurs and Heads of Sales. It enables managing a team of closers and setters, driving acquisition campaigns, tracking team KPIs and automating closer onboarding. It's the French alternative to iClosed, designed for sales team management.",
  sd_faq_how_many_q: 'How many closers can I add to CloseOS CRM?',
  sd_faq_how_many_a: 'As many as you want. CloseOS CRM imposes no limit on your team of closers and setters.',
  sd_faq_gdpr_q: 'Is the data secure and GDPR-compliant?',
  sd_faq_gdpr_a: 'Yes. CloseOS CRM is 100% GDPR-compliant. All data is securely hosted, isolated by organization, and no third party has access. You remain the owner of your data at all times.',
}
