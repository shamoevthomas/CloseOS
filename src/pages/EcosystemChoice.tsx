...
export const EcosystemChoice: React.FC<EcosystemChoiceProps> = ({ onChooseSales, onChooseBusiness }) => {
  ...
  return (
    <div className="bg-[#f4f2f1] min-h-screen font-sans text-[#111111] flex flex-col items-center justify-center px-6 py-16 selection:bg-[#8a43e1]/20">
      {/* Logo */}
      <motion.img
      ...
      >
        <span className="text-sm font-medium text-stone-800">
          Bienvenue dans l'écosystème <span className="font-bold">CloseOS</span>
        </span>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl w-full">
        ...
        <motion.div
          ...
          className="bg-white rounded-3xl border border-stone-200 shadow-sm p-8 flex flex-col items-center text-center hover:shadow-lg transition-shadow duration-300"
        >
          <img
            src="/logo Sales.png"
            alt="CloseOS Sales"
          ...
          />
          <h2 className="text-xl font-bold text-[#111111] mb-2">Je suis Closer</h2>
        ...
        <motion.div
          ...
          className="bg-white rounded-3xl border border-stone-200 shadow-sm p-8 flex flex-col items-center text-center hover:shadow-lg transition-shadow duration-300 relative"
        >
          {/* Badge Nouveau */}
