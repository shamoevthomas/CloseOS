        ...
        <div className="bg-emerald-500/5 border border-emerald-500/10 rounded-xl p-4 mb-8 text-left flex gap-4 items-start">
            ...
            <div>
                ...
                <p className="text-xs text-emerald-500/80 leading-snug">
                    Le décompte de vos 7 jours d'essai gratuit ne commencera <strong>que le jour officiel de l'ouverture</strong> du logiciel. Vous ne perdez aucun jour en attendant.
                </p>
            </div>
        </div>
