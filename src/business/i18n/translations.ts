...
export interface BusinessTranslations {
  ...
  onboarding_owner_help_hint: string;
...
export const fr: BusinessTranslations = {
  ...
  onboarding_owner_help_hint: "Besoin d'aide pour demarrer ? Tout est dans Parametres -> Centre d'aide : le « par ou commencer » et tous les guides.",
  ...
  crm_tags: 'Tags',
  dashboard_member_hello: 'Bonjour',
  dashboard_member_last_sync: 'Dernière synchro',
  dashboard_member_revenue: "Chiffre d'affaires",
  dashboard_member_leads_total: 'Leads au total',
  dashboard_member_appointments: 'Rendez-vous',
  dashboard_member_appointment_label: 'Rendez-vous',
  dashboard_member_closing_rate: 'Taux de closing',
  dashboard_member_noshow_rate: 'Taux de no-show',
  dashboard_member_ca_generated: 'CA généré',
  dashboard_member_signed_presented: 'Signés / présentés',
  dashboard_member_active_campaigns: 'Campagnes actives',
  dashboard_member_campaign_assigned: 'Campagne assignée',
  dashboard_member_my_objectives: 'Mes objectifs',
  dashboard_member_my_reminders: 'Mes rappels',
  dashboard_member_no_reminders: 'Aucun rappel',
  dashboard_member_next_appointments: 'Prochains rendez-vous',
  dashboard_member_no_appointments: 'Aucun rendez-vous',
  dashboard_member_view_all: 'Tout voir',
  dashboard_member_this_month: 'Ce mois-ci',
  dashboard_member_today_short: 'Auj.',
  dashboard_member_tomorrow_short: 'Demain',
  dashboard_member_live: 'En direct',
  dashboard_member_deadline: 'Échéance',
  dashboard_member_expired: 'Expiré',
  dashboard_member_overdue_count: 'En retard',
  dashboard_member_overdue_days: 'jours de retard',
  dashboard_member_absences_on: 'Absences le',
  metric_revenue: 'CA',
  metric_leads: 'Leads',
  metric_appointments: 'RDV',
  metric_conversion_rate: 'Taux de conversion',
  metric_noshow_rate: 'Taux de no-show',
  metric_sales_count: 'Ventes',
  team_closers_label: 'Closers',
  team_setters_label: 'Setters',
...
export const en: BusinessTranslations = {
  ...
  onboarding_owner_help_hint: "Need help getting started? Everything is in Settings -> Help center: the \"getting started\" guide and all articles.",
  ...
  crm_tags: 'Tags',
  dashboard_member_hello: 'Hello',
  dashboard_member_last_sync: 'Last sync',
  dashboard_member_revenue: 'Revenue',
  dashboard_member_leads_total: 'Total leads',
  dashboard_member_appointments: 'Appointments',
  dashboard_member_appointment_label: 'Appointment',
  dashboard_member_closing_rate: 'Closing rate',
  dashboard_member_noshow_rate: 'No-show rate',
  dashboard_member_ca_generated: 'Revenue generated',
  dashboard_member_signed_presented: 'Signed / presented',
  dashboard_member_active_campaigns: 'Active campaigns',
  dashboard_member_campaign_assigned: 'Assigned campaign',
  dashboard_member_my_objectives: 'My objectives',
  dashboard_member_my_reminders: 'My reminders',
  dashboard_member_no_reminders: 'No reminders',
  dashboard_member_next_appointments: 'Next appointments',
  dashboard_member_no_appointments: 'No appointments',
  dashboard_member_view_all: 'View all',
  dashboard_member_this_month: 'This month',
  dashboard_member_today_short: 'Today',
  dashboard_member_tomorrow_short: 'Tomorrow',
  dashboard_member_live: 'Live',
  dashboard_member_deadline: 'Deadline',
  dashboard_member_expired: 'Expired',
  dashboard_member_overdue_count: 'Overdue',
  dashboard_member_overdue_days: 'days overdue',
  dashboard_member_absences_on: 'Time off on',
  metric_revenue: 'Revenue',
  metric_leads: 'Leads',
  metric_appointments: 'Appointments',
  metric_conversion_rate: 'Conversion rate',
  metric_noshow_rate: 'No-show rate',
  metric_sales_count: 'Sales',
  team_closers_label: 'Closers',
  team_setters_label: 'Setters',
  callroom_auto_save: 'Auto-save',
  callroom_back_dashboard: 'Back to dashboard',
  callroom_current_notes: 'Current notes',
  callroom_desktop_only: 'Available on desktop only',
  callroom_desktop_only_desc: 'The Call Room needs a wide screen to work properly.',
  callroom_download_pdf: 'Download the PDF',
  callroom_email_address: 'Email address',
  callroom_email_placeholder: 'email@example.com',
  callroom_email_sent: 'Email sent successfully',
  callroom_end: 'End call',
  callroom_formulas_tab: 'Plans',
  callroom_header: 'Closer Call Room',
  callroom_loading: 'Loading...',
  callroom_monthly_label: 'Monthly',
  callroom_no_formulas: 'No plan configured',
  callroom_no_note: 'No note',
  callroom_no_resources_formula: 'No resources for this plan.',
  callroom_no_script: 'No script found.',
  callroom_no_title: 'Untitled',
  callroom_notepad: 'Notepad',
  callroom_notes_placeholder: 'Take notes...',
  callroom_per_month: '/ month',
  callroom_per_year: '/ year',
  callroom_prospect_sheet: 'Prospect Sheet',
  callroom_quote: 'On quote',
  callroom_quote_desc: 'Price set per project, contact us for a custom quote.',
  callroom_record: 'Record',
  callroom_recording_failed: 'Could not start the recording.',
  callroom_resources_tab: 'Resources',
  callroom_select_formula: 'Select a plan',
  callroom_select_formula_resources: 'Select a plan to see its resources.',
  callroom_send: 'Send',
  callroom_send_pdf: 'Send the PDF',
  callroom_subscription: 'Subscription',
  callroom_yearly_label: 'Yearly',
