...
export function Sidebar({ onOpenSettings, isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div className={cn(
        "fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 transition-transform duration-300 lg:static lg:translate-x-0",
        ...
        <div className="flex h-16 items-center justify-between px-6 border-b border-gray-200 dark:border-slate-800">
          ...
          <button onClick={onClose} className="lg:hidden p-2 text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white">
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <div className="px-4 pb-2">
          <div className={`rounded-xl border px-3 py-2.5 ${user?.user_metadata?.is_founder
            ...
            <div className="flex items-center gap-3">
              <div className={`p-2 rounded-lg shrink-0 ${user?.user_metadata?.is_founder
              ...
              <div className="min-w-0">
                <p className={`text-sm font-bold truncate ${user?.user_metadata?.is_founder ? 'text-blue-700 dark:text-blue-400' : 'text-slate-700 dark:text-slate-300'
                  }`}>
