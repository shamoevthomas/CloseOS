                    ...
                    <div className="relative w-full max-w-4xl h-[80vh] bg-white rounded-2xl shadow-2xl overflow-hidden">
                        <button
                            onClick={() => {
                                ...
                                onClose(); // Also close the retention modal
                            }}
                            className="absolute top-4 right-4 z-10 p-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-white transition-colors"
                        >
                            <X className="h-5 w-5" />
                        </button>
                        <Cal
                            calLink="thomas-shamoev-b00jfc/15min"
                            config={{
                                theme: 'light'
                            }}
                        />
