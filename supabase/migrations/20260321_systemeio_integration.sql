...
-- Store systemeio contact ID on business_prospects for bidirectional sync
ALTER TABLE business_prospects ADD COLUMN IF NOT EXISTS systemeio_contact_id text;
